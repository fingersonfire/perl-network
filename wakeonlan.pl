...
# Source : https://plone.unige.ch/EULER/technic/documentation/systeme-informatique-pour-super-user/installation-serveur-disque-synology-cluster/installtion-du-nas/shutdown-and-reset-du-nas
#
#########################################################################       
